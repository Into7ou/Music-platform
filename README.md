...
> [!IMPORTANT]
> **协作者须知**：本项目后端服务运行在 Docker 环境中。
> 
> - 首次开发请配置相关的容器环境并启动
> - 如需本地开发，请在您的电脑上完善相关服务的配置
> - 遇到连接问题，请检查 `application.yml` 中的数据库地址配置（由于Docker中的MySQL服务与本地MySQL服务端口冲突，故修改过端口号）
...
感谢所有参与到开发/测试中的朋友们。如果有更多新点子，欢迎联系作者或提交PR、ISSUE。

[![Contributors](https://contributors-img.web.app/image?repo=Into7ou/Music-platform&max=50&columns=10)](https://github.com/Into7ou/Music-platform/graphs/contributors)
